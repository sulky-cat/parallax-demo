(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const parallaxPlug = new Parallax(document.querySelectorAll("[data-prlx-parent]"));
        const parallax_all = document.querySelectorAll("[data-event-all]");
        parallax_all.forEach((el => {
            el.addEventListener("click", (() => {
                const data = el.dataset.eventAll;
                switch (data) {
                  case "init":
                    parallaxPlug.setEvents();
                    break;

                  case "destroy":
                    parallaxPlug.destroyEvents();
                    break;
        ...
        const jsParent = parallaxPlug.elements.find((el => el.parent.classList.contains("demo_js")));
        const one = document.querySelectorAll("[data-event]");
        one.forEach((el => {
            el.addEventListener("click", (() => {
                console.log(1212);
